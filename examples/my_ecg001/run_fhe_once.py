...
def main():
    ...
    parser.add_argument('--task-dir', type=str, default='./my_ecg001/runs/exp_over009/task')
    parser.add_argument('--input-csv', type=str, default='./my_ecg001/runs/exp_over009/task/client/ecg_input.csv')
    parser.add_argument('--binary', type=str, default='./build/examples/inference')
    parser.add_argument('--threads', type=int, default=1)
    parser.add_argument('--save-log', type=str, default='./my_ecg001/runs/exp_over009/task/client/fhe_run.log')
