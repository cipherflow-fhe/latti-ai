...
def main():
    ...
    parser.add_argument('--processed-dir', type=str, default='./my_ecg001/processed_over_1to1')
    ...
    parser.add_argument('--output-dir', type=str, default='./my_ecg001/runs/exp_over009/model')
    parser.add_argument('--input-dir', type=str, default='./my_ecg001/runs/exp_over009/model')
    parser.add_argument('--export-dir', type=str, default='./my_ecg001/runs/exp_over009/task/server')
