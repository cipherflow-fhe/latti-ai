...
Layer::populate_rotations_1_side(CkksContext& ctx, const CkksCiphertext& x, int n_rotation, int unit) {
...
std::vector<CkksCiphertext>
Layer::populate_rotations_2_sides(CkksContext& ctx, const CkksCiphertext& x, int n_rotation, int unit) {
    std::vector<CkksCiphertext> result;
