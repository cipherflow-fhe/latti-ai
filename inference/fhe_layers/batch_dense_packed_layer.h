...
// Batch dense layer for Feature0DEncrypted values packed with
// Feature0DEncrypted::batch_pack().
//
...
class BatchDensePackedLayer : public Layer {
public:
    BatchDensePackedLayer(const ls::CkksParameter& param_in,
                          const Duo& shape_A,
                          const Duo& shape_P,
    ...
    Feature0DEncrypted run(ls::CkksContext& ctx, const Feature0DEncrypted& A);
