...
class GraphPartitioner:
    ...
    def generate_solutions(
        ...
        for terminal_lv in range(config.fhe_param.max_level + 1):
            ...
            if (
                terminal_lv == 0
                # For simplicity, successors from level_cost 0 computes will not
                # have restoring nodes afterwards. These cases can always be absorbed by
                # some previous nodes generated by non-zero level_cost computes.
