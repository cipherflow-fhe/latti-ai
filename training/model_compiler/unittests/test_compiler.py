...
class TestSingleLayer(CompilerTestBase):
    ...
    def test_vit_from_onnx(self):
        ...
        self.temp_onnx_path = '/home/wangy/latti-ai/runs/vit/poly_deit_tiny_patch16_224.onnx'  #'/home/wangy/latti-ai/runs/part_vit/deit_tiny_patch16_224_until_block0_after_mlp_add.onnx' # #'runs/deit_tiny_patch16_224_until_block0_after_mlp_add.onnx'
