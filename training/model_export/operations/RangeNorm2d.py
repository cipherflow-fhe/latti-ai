...
class RangeNorm2dComputeNode(ComputeNode):
    """Compute node for RangeNorm2d operation"""

    def __init__(
        self, layer_id: str, layer_type: str, feature_input: list[FeatureNode], feature_output: list[FeatureNode]
    ):
        super(RangeNorm2dComputeNode, self).__init__(layer_id, layer_type, feature_input, feature_output)
        self.layer_type = 'range_norm'
